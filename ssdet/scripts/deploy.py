#!/usr/bin/env python
"""SSDet post-training deploy: ONNX → TensorRT engine."""
...
from ssdet.deploy.pipeline import deploy_from_config, deploy_robot_toy_engine
from ssdet.paths import RUNTIME_YAML
