#!/usr/bin/env python
"""SSDet validation entry point (mAP on val set)."""
...
from ssdet.core.backbone import MoEn
from ssdet.core.detector import Detector
from ssdet.paths import ROBOT_TOY_BEST_BIN, RUNS_DIR, RUNTIME_YAML
from ssdet.utils.datasets import TensorDataset, collate_fn
from ssdet.utils.evaluation import CocoDetectionEvaluator
from ssdet.utils.tool import LoadYaml
