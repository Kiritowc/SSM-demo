...
from cv.cfg import EVENT_STREAM, device, task_config, trainLogDir
...
from cv.core.training import DetectorTrainingOrchestrator, TaskStatusLedger


class sunshinkDet:
    def __init__(
        self,
        yaml="artifacts/cv/runtime/self.yaml",
        weight=None,
        model=None,
        ins=None,
        ous=None,
