...
def deploy_robot_toy_engine(
    *,
    ...
    model_name: str,
    val_txt: str,
    yaml_path: str = "artifacts/cv/runtime/self.yaml",
    ...
    from cv._demo_services import stop_camera
    ...
    log_deploy_complete()
    if restart_camera:
        from cv._demo_services import start_camera
...
def main() -> None:
    ...
    parser.add_argument("--yaml-path", default="artifacts/cv/runtime/self.yaml")
    parser.add_argument(
        "--restart-camera",
        action="store_true",
