...
from cv.cfg import RUNTIME_YAML, taskCfgDir, task_config
from cv.core.tasking import TaskConfigMaterializer, TaskTopologyCompiler


def ensure_task_config(configfile: str) -> None:
    """Seed task_config.json from cv/configs/default.yaml when missing."""
    ...
    print(f"已根据 cv/configs/default.yaml 生成: {configfile}")
...
class TrainRunner:
    ...
    def launch(self) -> dict:
        ...
        from cv.core.training import DetectorTrainer
