...
from sunshink_cv.cfg import taskCfgDir
from sunshink_cv.core.tasking import TaskConfigMaterializer, TaskTopologyCompiler
from sunshink_cv.core.training import TrainingLaunchWindow
...
class LegacyTrainBootstrap:
    ...
    def launch(self):
        ...
        from sunshink_cv.ssDet import sunshinkDet
