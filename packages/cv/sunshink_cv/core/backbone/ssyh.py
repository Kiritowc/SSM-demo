...
SSYH_BLUEPRINTS = {
    "ssyh_a": BackboneBlueprint(
        ...
        artifact=EncryptedArtifactSpec(weight_path="packages/cv/sunshink_cv/core/backbone/ssyh/ssyh_a.bin"),
    ),
    "ssyh_b": BackboneBlueprint(
        ...
        notes=("c2f-yoloish", "encrypted-family"),
        artifact=EncryptedArtifactSpec(weight_path="packages/cv/sunshink_cv/core/backbone/ssyh/ssyh_b.bin"),
    ),
    "ssyh_c": BackboneBlueprint(
        ...
        notes=("c2f-yoloish", "encrypted-family"),
        artifact=EncryptedArtifactSpec(weight_path="packages/cv/sunshink_cv/core/backbone/ssyh/ssyh_c.bin"),
    ),
    "ssyh_d": BackboneBlueprint(
        ...
        notes=("c2f-yoloish", "encrypted-family"),
        artifact=EncryptedArtifactSpec(weight_path="packages/cv/sunshink_cv/core/backbone/ssyh/ssyh_d.bin"),
    ),
    "ssyh_e": BackboneBlueprint(
        ...
        notes=("c2f-yoloish", "encrypted-family"),
        artifact=EncryptedArtifactSpec(weight_path="packages/cv/sunshink_cv/core/backbone/ssyh/ssyh_e.bin"),
    ),
}
