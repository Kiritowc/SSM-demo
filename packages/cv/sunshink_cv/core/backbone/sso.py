...
SSO_BLUEPRINTS = {
    "sso_a": BackboneBlueprint(
        ...
        artifact=EncryptedArtifactSpec(weight_path="packages/cv/sunshink_cv/core/backbone/sso/sso_a.bin"),
    ),
    ...
    "sso_d": BackboneBlueprint(
        ...
        stage_channels=(24, 48, 96, 192),
        notes=("shufflenetv2-family", "partial-pretrained"),
        artifact=EncryptedArtifactSpec(weight_path="packages/cv/sunshink_cv/core/backbone/sso/sso_d.bin"),
    ),
