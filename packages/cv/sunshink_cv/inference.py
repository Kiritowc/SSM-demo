...
class ssDet():
    def __init__(self, input_width=416, input_height=416, conf=0.3, nms=0.4, weight="", verbose=True, names="cv/configs/self.names"):
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='类别名文件路径（不传则默认 cv/configs/self.names）',
    )
    parser.add_argument(
        '--output',
        '-o',
    ...
    if names_path is None:
        names_path = 'cv/configs/self.names'
