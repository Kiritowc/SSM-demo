...
from sunshink_cv.core.exporting import ExportRuntimeContext, exporter_registry


def convert_and_save_model(opt):
    if not hasattr(opt, "yaml"):
        opt.yaml = "cv/configs/self.yaml"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--yaml", type=str, default="cv/configs/self.yaml", help=".yaml config")
